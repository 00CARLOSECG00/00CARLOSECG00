...
I build data pipelines, ML systems, and AI-powered solutions. Currently focused on large-scale data processing, NLP, and semantic search — with hands-on experience in distributed computing (Databricks/PySpark) and cloud analytics (BigQuery).
